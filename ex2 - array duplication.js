...
const STUDENTS_DATA = [
  { firstName: "An", lastName: "Nimo", age: 20, batch: "007" },
  { firstName: "Bình", lastName: "kava", age: 22, batch: "008" },
  { firstName: "Cẩm", lastName: "Ran", age: 21, batch: "009" },
  { firstName: "An", lastName: "Lambrouce", age: 19, batch: "010" }, // Duplicate first name !
];
...
updateStudentAge("An", "Lambrouce", 30, "010");
